...
@Component
public class EncounterBaseListener implements JobExecutionListener {
    ...
    public void beforeJob(JobExecution jobExecution) {
        ...
        batchUtil.setLockForCategory(category, false);
    }

    @Override
    public void afterJob(JobExecution jobExecution) {
        JobParameters jobParameters = jobExecution.getJobParameters();
        batchUtil.saveLastProcessEventForJob(jobParameters, jobExecution.getExecutionContext());
