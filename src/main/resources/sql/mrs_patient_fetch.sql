select
    ...
    pn.middle_name,
    pn.family_name,
    pi_prep_oi.identifier as prep_oi_identifier,
...
from person per
     ...
     left join patient_identifier pi_prep_oi on pi_prep_oi.patient_id=per.person_id and pi_prep_oi.identifier_type = (select patient_identifier_type_id from patient_identifier_type where name = 'PREP/OI Identifier')
where per.person_id = ?;
